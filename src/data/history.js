...
const line = (id, name, ab, h, r, rbi, bb = 0) => ({
  pid: homePid(id),
  name,
  team: 'home',
  ab,
...
export const SEED_HISTORY = [
  ...
  },
  {
    ...
    innings: 7,
    lines: [
      line(0, 'Maya Ortiz', 3, 2, 2, 2),
      line(1, 'Deon Wallace', 4, 3, 2, 3),
      line(2, 'Priya Shah', 4, 2, 2, 1),
  ...
  },
  {
    ...
    lines: [
      ...
      line(3, 'Cole Bennett', 3, 0, 0, 0),
      line(4, 'Ana Fuentes', 3, 1, 1, 0),
      line(5, 'Jordan Lee', 3, 0, 0, 0),
